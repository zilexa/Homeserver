...
Note the snapshots created specifically for SnapRAID are seperate from the snapshots created by [I. BTRFS subvolume backups](https://github.com/zilexa/Homeserver/tree/master/Backups-guide), which maintains a timeline (X days, X weeks, X months) and copies snapshots to backup drives. 
