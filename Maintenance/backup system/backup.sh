...
nocache rsync -azXA --info=progress2 --delete --inplace --numeric-ids --exclude '/mnt/pool/Users/Local/Asterix/TV' /mnt/pool/Users/Local/ /mnt/disks/backup1/users.backup/

# Create snapshots of synced users data
btrbk -c /home/asterix/docker/HOST/users-backup.conf -v run
...
btrbk -c /home/asterix/docker/HOST/system-backup.conf -v run
