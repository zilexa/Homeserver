...
Optional: verify the data is identical by doing a dryrun with rsync (nothing will be modified) to list files that are missing or not 100% identical (checksum based):\
