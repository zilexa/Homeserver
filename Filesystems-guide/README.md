...
1. Decide the purpose of each of your drives! You want at least a filesystem for *Media* and one for *Users*. That could be a single drive for each ([Filesystem Option 1](https://github.com/zilexa/Homeserver/blob/master/Filesystems-guide/Filesystems-options.md#option-1-all-your-data-easily-fits-on-a-single-disk)) or a single filesystem for each where the filesystems span across multiple drives [(Filesystem Option 3)]([https://github.com/zilexa/Homeserver/blob/master/Filesystems-guide/Filesystems-options.md](https://github.com/zilexa/Homeserver/blob/master/Filesystems-guide/Filesystems-options.md#option-3-use-btrfs-data-duplication) or multiple single drives with individual filesystems, pooled together with MergerFS mountpoints, one MergerFS mountpoint for each [Filesystem Option 2](https://github.com/zilexa/Homeserver/blob/master/Filesystems-guide/Filesystems-options.md#option-2-individual-filesystems-drives-pooled-via-mergerfs). 
