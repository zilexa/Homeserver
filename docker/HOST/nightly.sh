...
docker exec -w /var/www/html/cron filerun php make_thumbs.php --username FiLeRuNuSeR1 --size large
docker exec -w /var/www/html/cron filerun php make_thumbs.php --username FiLeRuNuSeR2 --size large
docker exec -w /var/www/html/cron filerun php make_thumbs.php --username FiLeRuNuSeR3 --size large
docker exec -w /var/www/html/cron filerun php make_thumbs.php --username FiLeRuNuSeR4 --size large
