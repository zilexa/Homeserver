...
# -------------------------
run_task btrfs balance start -dusage=10 -musage=5 /dev/nvme0n1p2
run_task btrfs balance start -v -dusage=20 -musage=10 /dev/nvme0n1p2
run_task btrfs balance start -dusage=10 -musage=5 /dev/nvme1n1
run_task btrfs balance start -v -dusage=20 -musage=10 /dev/nvme1n1
run_task btrfs balance start -dusage=10 -musage=5 /dev/sdc
run_task btrfs balance start -v -dusage=20 -musage=10 /dev/sdc
run_task btrfs balance start -dusage=10 -musage=5 /dev/sdd
run_task btrfs balance start -v -dusage=20 -musage=10 /dev/sdd
run_task btrfs balance start -dusage=10 -musage=5 /dev/sdb
run_task btrfs balance start -v -dusage=20 -musage=10 /dev/sdb
